...
dailyMissions: [
  ...
  missions: [
    ...
    { title: "1v2 Clutch",            desc: "Gewinne einen 1v2 Clutch in Valorant. Kein Glück – nur Skill. Clip in die Gruppe.",                         icon: "🔫", type: "CHALLENGE" },
    ...
    { title: "Comp Grind",            desc: "Spiel 5 Comp-Runden am Stück – kein Aufgeben, egal was passiert.",                                       icon: "🏆", type: "CHALLENGE" },
    { title: "Ocean Vibe",            desc: "Schau mit jemandem einen Ocean- oder Natur-Doku-Clip und tauscht euch danach aus.",                         icon: "🌊", type: "QUEST"     },
  ...
  rewards: [
    ...
    { name: "Genshin Anhänger",               desc: "Groß genug um aufzufallen. May the wind be with you." },
    ...
    { name: "Valorant Keychains",             desc: "Reaver-Ersatz bis die Primordium in den Shop kommt." },
    { name: "Toffifee",                       desc: "Rund. Lecker. Sofort aufessen." },
    { name: "Sailor Moon Luna",               desc: "Die schwarze Wächter-Katze. Eine Katze kommt selten allein." },
    { name: "Gary (Spongebob)",               desc: "Meow. Der loyalste Begleiter, die schnellste Katze in Bikini Bottom" },
    { name: "Columbina Anhänger",             desc: "Babygirl Columbina uwu." },
    ...
    { name: "Genshin Sticker",                desc: "Deploy where needed. Waifus für unterwegs." },
    { name: "Alastor Tubbz",                  desc: "Madness im Entenformat. Absolut legendär." },
    { name: "Penis Motivierer",               desc: "Für den täglichen Reminder." },
    ...
    { name: "Wächter (3D Druck)",             desc: "Bewacht ab jetzt dein Setup." },
    { name: "Einhornbad",                     desc: "Badewanne plus Einhorn-Vibes. Selbstpflege auf einem neuen Level." },
    { name: "Tee",                            desc: "Zur Beruhigung nach dem Comp-Grind." },
